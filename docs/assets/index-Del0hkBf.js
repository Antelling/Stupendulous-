...
`,H=`// Elastic double pendulum ODE right-hand side
...
`,U=`// Nonlinear elastic double pendulum ODE right-hand side
...
`,E=`// Compute bob2 position given angles and arm lengths
...
`,K=`// Hash function for random perturbation
...
`;class S{static buildInit(t,i){return t==="rigid"?i==="distance"?this.rigidDistanceInit():this.rigidDivergenceInit():t==="nonlinear"?i==="distance"?this.nonlinearDistanceInit():this.nonlinearDivergenceInit():i==="distance"?this.elasticDistanceInit():this.elasticDivergenceInit()}static buildPhysics(t){return t==="rigid"?this.rigidPhysics():t==="nonlinear"?this.nonlinearPhysics():this.elasticPhysics()}static buildAccumulate(t){return t==="rigid"?this.rigidAccumulate():t==="nonlinear"?this.nonlinearAccumulate():this.elasticAccumulate()}static buildBlit(){return`${v}
...
}`}static buildDivergenceStep(t){return t==="rigid"?this.rigidDivergenceStep():t==="nonlinear"?this.nonlinearDivergenceStep():this.elasticDivergenceStep()}static chunkCoordHelpers(){return`
