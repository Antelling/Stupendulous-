var rt=Object.defineProperty;var nt=(h,t,e)=>t in h?rt(h,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):h[t]=e;var o=(h,t,e)=>nt(h,typeof t!="symbol"?t+"":t,e);(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))i(s);new MutationObserver(s=>{for(const a of s)if(a.type==="childList")for(const r of a.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&i(r)}).observe(document,{childList:!0,subtree:!0});function e(s){const a={};return s.integrity&&(a.integrity=s.integrity),s.referrerPolicy&&(a.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?a.credentials="include":s.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function i(s){if(s.ep)return;s.ep=!0;const a=e(s);fetch(s.href,a)}})();const J=["angle1","velocity1","angle2","velocity2"],Q=["angle1","velocity1","stretch1","stretchRate1","angle2","velocity2","stretch2","stretchRate2"],ot={angle1:"θ₁",velocity1:"ω₁",angle2:"θ₂",velocity2:"ω₂",stretch1:"r₁",stretchRate1:"ṙ₁",stretch2:"r₂",stretchRate2:"ṙ₂"},V=["angle1","velocity1","stretch1","stretchRate1","angle2","velocity2","stretch2","stretchRate2"],ut={angle1:Math.PI,velocity1:5,angle2:Math.PI,velocity2:5,stretch1:.5,stretchRate1:5,stretch2:.5,stretchRate2:5};function G(h){const t=new Array(V.length).fill(0);return t[V.indexOf(h)]=1,t}function tt(h){return h.oblique.enabled?{xDir:h.oblique.xDir,yDir:h.oblique.yDir}:{xDir:G(h.phaseSpace.x.dimension),yDir:G(h.phaseSpace.y.dimension)}}function H(h){return[h[0],h[1],h[4],h[5]]}function U(h){return[h[0],h[1],h[2],h[3]]}function N(h){return[h[4],h[5],h[6],h[7]]}function lt(h){const t=h==="rigid"?J:Q,e=(n,u)=>{let l=0;for(let c=0;c<n.length;c++)l+=n[c]*u[c];return l},i=()=>{const n=new Array(V.length).fill(0);for(const u of t){const l=V.indexOf(u);n[l]=(Math.random()*2-1)*ut[u]}return n},s=(n,u)=>{const l=e(n,n)||1,c=e(u,n)/l;return u.map((m,d)=>m-c*n[d])},a=i();let r=s(a,i());return e(r,r)<1e-6&&(r=s(a,i())),{enabled:!0,xDir:a,yDir:r}}const ht={system:"rigid",vizMode:"distance",resolution:512,chunkSize:512,phaseSpace:{x:{dimension:"angle1",min:-Math.PI,max:Math.PI},y:{dimension:"angle2",min:-Math.PI,max:Math.PI},initialValues:{angle1:0,velocity1:0,angle2:0,velocity2:0,stretch1:0,stretchRate1:0,stretch2:0,stretchRate2:0}},oblique:{enabled:!1,xDir:G("angle1"),yDir:G("angle2")},dt:.002,iterationsPerFrame:10,maxIter:5e3,perturb:1e-5,perturbDistribution:"uniform",trials:1,m1:1,m2:1,L1:1,L2:1,k1:50,k2:50,colormap:6,toneMapping:0,seed:Math.random()*1e3},ct={rigid:"Rigid",elastic12:"Elastic Double Pendulum",nonlinear:"Nonlinear Elastic Pendulum"},dt={distance:"Bob2 Distance",divergence:"Divergence Time",divergenceDistance:"Divergence Distance"};class ft{constructor(t){o(this,"buffer");this.gl=t;const e=t.createBuffer();if(!e)throw new Error("Failed to create buffer");this.buffer=e;const i=new Float32Array([-1,-1,1,-1,-1,1,1,1]);t.bindBuffer(t.ARRAY_BUFFER,this.buffer),t.bufferData(t.ARRAY_BUFFER,i,t.STATIC_DRAW)}bind(){this.gl.bindBuffer(this.gl.ARRAY_BUFFER,this.buffer)}draw(){this.gl.drawArrays(this.gl.TRIANGLE_STRIP,0,4)}}class et{constructor(t){this.gl=t}createFloatTexture(t){const e=this.gl.createTexture();if(!e)throw new Error("Failed to create texture");return this.gl.bindTexture(this.gl.TEXTURE_2D,e),this.gl.texImage2D(this.gl.TEXTURE_2D,0,this.gl.RGBA32F,t,t,0,this.gl.RGBA,this.gl.FLOAT,null),this.gl.texParameteri(this.gl.TEXTURE_2D,this.gl.TEXTURE_MIN_FILTER,this.gl.NEAREST),this.gl.texParameteri(this.gl.TEXTURE_2D,this.gl.TEXTURE_MAG_FILTER,this.gl.NEAREST),this.gl.texParameteri(this.gl.TEXTURE_2D,this.gl.TEXTURE_WRAP_S,this.gl.CLAMP_TO_EDGE),this.gl.texParameteri(this.gl.TEXTURE_2D,this.gl.TEXTURE_WRAP_T,this.gl.CLAMP_TO_EDGE),e}createTexturePair(t){return[this.createFloatTexture(t),this.createFloatTexture(t)]}bindTexture(t,e){this.gl.activeTexture(this.gl.TEXTURE0+t),this.gl.bindTexture(this.gl.TEXTURE_2D,e)}}class it{constructor(t){this.gl=t}getLocation(t,e){return this.gl.getUniformLocation(t,e)}setIfFound(t,e,i){const s=this.getLocation(t,e);s!==null&&i(s)}set1f(t,e,i){this.setIfFound(t,e,s=>this.gl.uniform1f(s,i))}set1i(t,e,i){this.setIfFound(t,e,s=>this.gl.uniform1i(s,i))}set2f(t,e,i,s){this.setIfFound(t,e,a=>this.gl.uniform2f(a,i,s))}set4f(t,e,i,s,a,r){this.setIfFound(t,e,n=>this.gl.uniform4f(n,i,s,a,r))}set1b(t,e,i){this.setIfFound(t,e,s=>this.gl.uniform1i(s,i?1:0))}}class mt{constructor(t){this.gl=t}create(){const t=this.gl.createFramebuffer();if(!t)throw new Error("Failed to create framebuffer");return t}attachColor(t,e){this.gl.framebufferTexture2D(this.gl.FRAMEBUFFER,t,this.gl.TEXTURE_2D,e,0)}checkStatus(){const t=this.gl.checkFramebufferStatus(this.gl.FRAMEBUFFER);if(t!==this.gl.FRAMEBUFFER_COMPLETE)throw new Error(`Framebuffer incomplete: ${t}`)}bind(t){this.gl.bindFramebuffer(this.gl.FRAMEBUFFER,t)}}class Y{constructor(t){this.gl=t}compile(t,e){const i=this.gl.createShader(t);if(!i)throw new Error("Failed to create shader");if(this.gl.shaderSource(i,e.trim()),this.gl.compileShader(i),!this.gl.getShaderParameter(i,this.gl.COMPILE_STATUS)){const s=this.gl.getShaderInfoLog(i);throw this.gl.deleteShader(i),new Error(`Shader compile error: ${s}`)}return i}linkProgram(t,e,i){const s=this.compile(this.gl.VERTEX_SHADER,t),a=this.compile(this.gl.FRAGMENT_SHADER,e),r=this.gl.createProgram();if(!r)throw new Error("Failed to create program");if(this.gl.attachShader(r,s),this.gl.attachShader(r,a),this.gl.linkProgram(r),this.gl.deleteShader(s),this.gl.deleteShader(a),!this.gl.getProgramParameter(r,this.gl.LINK_STATUS)){const n=this.gl.getProgramInfoLog(r);throw this.gl.deleteProgram(r),new Error(`Program link error (${i}): ${n}`)}return{program:r,name:i}}}const k=`// Rigid double pendulum ODE right-hand side
